  ...
  <div class="pt-header">
        ...
        <div class="row px-2 py-2">
          ...
          <div class="col-12 py-4 text-center">
            <p class="body-copy color-white">
              Join us on December 1st, 2017 for AgileCamp Dallas! See below for
              <a
                href="/"
    ...
    <div class="bg-color-gray-lt-2">
      <section class="container py-4">
        ...
        <div id="speakerEmCampbellPretty" class="row text-white py-2">
          <div class="col-12 col-md-3">
            <div class="img-wrap-ac-speaker-port m-auto">
              <img
                class="img-fluid img-brighten-110"
                src="~assets/images/speaker-em-campbell-pretty-port.jpg"
                alt="Em Campbell-Pretty"
              />
            </div>
          </div>
          <div class="col-12 col-md-9 mt-2 text-center text-md-left">
            ...
            <p class="body-copy">
              Em Campbell-Pretty is the author of the Amazon Number #1 Best
              Seller: <em>Tribal Unity.</em>
              She is an internationally acclaimed business strategist, speaker
              and one of Australia’s leading Enterprise Agile consultants.
            </p>
            <read-more>
              <p key="p1" class="body-copy">
                At the heart of Em’s success is her passion for creating
                cultures of transparency, lean leadership, learning, innovation
                and fun.
              </p>
              <p key="p2" class="body-copy">
                Em is a SAFe&reg; Fellow and an active member of the global
                Agile community. She is a thought leader on scaling culture and
                creating agile tribes. Her commitment to building great leaders
                and transforming culture has made her a sort after speaker at
...
export default {
  ...
  data() {
    return {
      ...
      // Event info
      registerLink:
        'https://www.eventbrite.com/e/agilecamp-dallas-2017-registration-34757472536',
      schedId: 'agilecampdallas2017.sched.com',

      // Location info
      directionsLink:
        'https://www.google.com/maps/place/Irving+Convention+Center+at+Las+Colinas/@32.878001,-96.9452897,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0xaae568269589f1f6!8m2!3d32.878001!4d-96.943101',
