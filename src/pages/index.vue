  ...
  <div>
    ...
    <div class="bg-color-white">
      <section class="container py-4" id="pastYearsSection">
        <div class="row">
          <div class="col-12 qq-text-center">
        ...
        <div class="row">
          <div class="col-12">
            <p class="body-copy">
              Get a flavor of our conferences. Learn about previous AgileCamp conferences including speakers and session tracks. And, don’t miss out on AgileCamp 2018. Reserve your spot by registering today.
            </p>
          </div>
        </div>
