        ...
        <div class="row pb-2">
          ...
          <div class="col-4 col-lg-2 px-4 py-4 d-flex flex-row flex-nowrap justify-content-center align-items-center">
            <a href="http://scopeofsuccess.libsyn.com" target="_blank" class="text-center">
              <img src="~assets/images/sponsor-sos-white.png" style="width: 80%;" />
            </a>
          </div>
        </div>
      </section>
            ...
            <div class="list-group">
              ...
              <div class="list-group-item list-group-item-action flex-column align-items-start">
                ...
                <div class="small mt-2" v-if="shownTravelIndex === 1">
                  ...
                  <p>From Baggage claim, walk toward the exit sign and go outside. Cross the street to the second island and walk to your right past the taxi stand. Stand under sign #7 shared ride services.</p>

                  <strong>Terminal B</strong>
                  <p>From Baggage claim follow the exit sign. Cross the street and look for the sign that says #5 Newark Airport Marriott Hotel.</p>

                  <strong>Terminal A</strong>
                  <p>From Baggage claim, take the escalator down toparkinglevelA.Walkthroughthevacant underground lot to the street curb. Look for green and white sign #8 that reads Newark Airport Marriott.</p>
