<template>
  <div class="bg-color-red">
    <section class="container">
      <div class="row py-2">
        <div class="col-6 col-md-3 offset-md-1 py-2 d-flex flex-row flex-nowrap justify-content-center align-items-center">
        ...
        <div class="col-12 col-md-4 py-3 d-flex flex-row flex-nowrap justify-content-center align-items-center">
          <a href="https://www.jpmorganchase.com" target="_blank" class="text-center">
            <img src="~assets/images/sponsor-jpmorgan-chase-white.png" style="width: 100%;"/>
          </a>
        </div>
       </div>
    </section>
