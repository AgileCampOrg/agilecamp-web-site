  ...
  <div class="bg-color-red">
    <section class="container">
      <div class="row py-3">
        ...
        <div class="col-4 col-lg-2 d-flex flex-row flex-nowrap justify-content-center align-items-center">
        ...
        <div class="col-4 col-lg-2 offset-2 offset-lg-0 d-flex flex-row flex-nowrap justify-content-center align-items-center">
