<template>
  <div class="row py-2" :class="textClass" id="speakerJurgenAppello">
    <div class="col-12 col-md-3">
      <div class="img-wrap-ac-speaker-port m-auto">
        <img class="img-fluid" src="~assets/images/speaker-jurgen-appello-port.jpg" alt="Jurgen Appello">
      </div>
    </div>
    <div class="col-12 col-md-9 mt-2 text-center text-md-left">
      ...
      <read-more :class="bodyClass">
        <p class="body-copy" key="p1">
          ...
          Since 2008, Jurgen writes a popular blog at NOOP.NL, offering ideas on the creative economy, agile management, organizational change, and personal development.
        </p>
        <p class="body-copy" key="p2">
          He is the author of the book <em>Management 3.0</em>, which describes the role of the manager in agile organizations.
          Jurgen has a new book, <em>Start-up, Scale-up and Screw-up</em> soon to be released in April 2019.
        </p>
      </read-more>
    </div>
  </div>
