      ...
      <section class="container py-4">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card my-4 card-inverse card-primary">
      ...
      <section class="container py-4" id="sponsorSection">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 py-2 d-flex flex-row flex-nowrap align-items-center">
            ...
            <a href="https://www.northeastern.edu/graduate/" target="_blank" class="mx-3"><img class="img-fluid" src="~assets/images/sponsor-nupjm-white.png" /></a>
          </div>

          <div class="col-sm-12 py-2 d-flex flex-row flex-nowrap align-items-center">
            <a href="https://disciplinedagileconsortium.org" target="_blank" class="mx-1"><img class="img-fluid" src="~assets/images/sponsor-dac-white.png" /></a>
            ...
            <a href="https://monarchagile.com" target="_blank" class="mx-1"><img class="img-fluid" src="~assets/images/sponsor-monarch-white.png" /></a>
          ...
          <div class="col-sm-12 py-2 d-flex flex-row flex-nowrap align-items-center">
            <a href="https://icagile.com" target="_blank" class="mx-4"><img class="img-fluid" src="~assets/images/sponsor-ica-white.png" /></a>
            <a href="http://scottambler.com" target="_blank" class="mx-4"><img class="img-fluid" src="~assets/images/sponsor-scottambler-white.png" /></a>
            <a href="http://www.eliassen.com/agile/" target="_blank" class="mx-4"><img class="img-fluid" src="~assets/images/sponsor-eliassengroup-white.png" /></a>
            <a href="https://www.scrumalliance.org" target="_blank" class="mx-4"><img class="img-fluid" src="~assets/images/sponsor-scrumalliance-white.png" /></a>
          </div>
        </div>
      </section>
    </div>
