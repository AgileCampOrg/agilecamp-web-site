      ...
      <section class="container py-4" id="sponsorSection">
        ...
        <div class="row">
          <div class="col-sm-12 py-2 d-flex flex-row flex-nowrap align-items-center">
            ...
            <a href="http://www.brattoninc.com" target="_blank" class="mx-3"><img class="img-fluid" src="~assets/images/sponsor-bratton-white.png" /></a>
          </div>
          ...
          <div class="col-sm-12 py-2 d-flex flex-row flex-nowrap align-items-center">
            ...
            <a href="https://www.daugherty.com" target="_blank" class="mx-2"><img class="img-fluid" src="~assets/images/sponsor-teamdaugherty-white.png" /></a>
            ...
            <a href="http://scottambler.com" target="_blank" class="mx-2"><img class="img-fluid" src="~assets/images/sponsor-scottambler-white.png" /></a>
            <div class="d-flex flex-column align-items-center mx-3">
              <a href="http://www.eliassen.com/agile/" target="_blank" class="my-2"><img class="img-fluid" src="~assets/images/sponsor-eliassengroup-white.png" /></a>
              <a href="https://www.scrumalliance.org" target="_blank" class="my-2"><img class="img-fluid" src="~assets/images/sponsor-scrumalliance-white.png" /></a>
            </div>
          </div>
        </div>
      </section>
